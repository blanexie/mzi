...
public class Example<T> {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public <V> Criteria andEqualTo(String colName, V value) {
            addCriterion(colName+" = ", value, colName);
            return (Criteria) this;
        }

        public <V> Criteria andNotEqualTo(String colName,V value) {
            addCriterion(colName+" <>", value, colName);
            return (Criteria) this;
        }

        public <V>  Criteria andGreaterThan(String colName,V value) {
            addCriterion(colName+" >", value, colName);
            return (Criteria) this;
        }

        public <V>  Criteria andGreaterThanOrEqualTo(String colName,V value) {
            addCriterion(colName+" >=", value, colName);
            return (Criteria) this;
        }

        public <V>  Criteria andLessThan(String colName,V value) {
            addCriterion(colName+" <", value, colName);
            return (Criteria) this;
        }

        public  <V> Criteria andLessThanOrEqualTo(String colName,V value) {
            addCriterion(colName+" <=", value, colName);
            return (Criteria) this;
        }

        public <V>  Criteria andLike(String colName,V value) {
            addCriterion(colName+" like", value, colName);
            return (Criteria) this;
        }

        public <V>  Criteria andNotLike(String colName,V value) {
            addCriterion(colName+" not like", value, colName);
            return (Criteria) this;
        }

        public <V>  Criteria andIn(String colName,List<V> values) {
            addCriterion(colName+" in", values, colName);
            return (Criteria) this;
        }

        public <V>  Criteria andNotIn(String colName,List<V> values) {
            addCriterion(colName+" not in", values, colName);
            return (Criteria) this;
        }

        public <V> Criteria andBetween(String colName,V value1, V value2) {
            addCriterion(colName+" between", value1, value2, colName);
            return (Criteria) this;
        }

        public <V> Criteria andNotBetween(String colName, V value1, V value2) {
